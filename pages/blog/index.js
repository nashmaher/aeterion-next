...
const POSTS = [
  {
    slug: "retatrutide-phase-3-results-2026",
    title: "Retatrutide Phase 3 Results: 28.7% Weight Loss in TRIUMPH-4 Trial",
    date: "March 5, 2026",
    category: "Clinical Research",
    readTime: "6 min read",
    excerpt: "Eli Lilly's triple agonist retatrutide achieved up to 28.7% average body weight loss in its first successful Phase 3 trial. Seven additional readouts expected throughout 2026. Here's everything researchers need to know.",
    content: `
...
*All products sold by Aeterion Labs are strictly for research purposes only. Not for human consumption.*
    `
  },
  {
    slug: "fda-peptide-reclassification-2026-rfk-category-2",
    title: "FDA Peptide Reclassification 2026: RFK Jr., Category 2, and What It Means for Researchers",
    date: "February 28, 2026",
    category: "Regulatory",
    readTime: "7 min read",
    excerpt: "RFK Jr. has signaled potential changes to the FDA's Category 2 peptide list — which currently bans BPC-157, TB-500, and 17 other compounds from compounding pharmacies. Here's the current regulatory landscape and what may change.",
    content: `
...
*All Aeterion Labs products are sold strictly for laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "bpc-157-vs-tb-500-recovery-research",
    title: "BPC-157 vs TB-500: Comparing Two Leading Recovery Research Peptides",
    date: "February 20, 2026",
    category: "Research Guide",
    readTime: "8 min read",
    excerpt: "BPC-157 and TB-500 are the two most studied recovery peptides, often combined in research protocols. This guide breaks down their distinct mechanisms, overlapping effects, and what the latest research shows about each.",
    content: `
...
*For laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "glp-1-research-peptides-complete-guide-2026",
    title: "GLP-1 Research Peptides: The Complete 2026 Guide — Semaglutide, Tirzepatide, Retatrutide & Beyond",
    date: "February 15, 2026",
    category: "Research Guide",
    readTime: "10 min read",
    excerpt: "The GLP-1 class has expanded from a single compound to a multi-generational family of metabolic research tools. This guide covers every major compound — mechanism, half-life, research data, and what distinguishes each from the others.",
    content: `
...
*All products for laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "growth-hormone-peptides-ipamorelin-cjc1295-sermorelin-comparison",
    title: "Growth Hormone Peptides Compared: Ipamorelin, CJC-1295, Sermorelin, MK-677 and More",
    date: "February 8, 2026",
    category: "Research Guide",
    readTime: "9 min read",
    excerpt: "The growth hormone secretagogue category includes GHRPs, GHRH analogues, and oral ghrelin mimetics — each with distinct receptor targets and GH release profiles. This research guide breaks down every major compound.",
    content: `
...
*For laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "longevity-peptides-research-2026-epitalon-humanin-mots-c",
    title: "Longevity Peptides in 2026: Epitalon, Humanin, MOTS-c and the Science of Aging Research",
    date: "January 30, 2026",
    category: "Research",
    readTime: "7 min read",
    excerpt: "A new class of mitochondria-derived and telomere-targeted peptides is reshaping longevity research. This guide covers Epitalon, Humanin, MOTS-c, Foxo4-DRI, and what the research actually shows.",
    content: `
...
*All products for laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "cognitive-peptides-noopept-dihexa-semax-research-guide",
    title: "Cognitive Enhancement Peptides: Noopept, Dihexa, Semax and the Neuroscience of Memory Research",
    date: "January 22, 2026",
    category: "Research Guide",
    readTime: "8 min read",
    excerpt: "The cognitive peptide category ranges from well-characterized BDNF modulators to novel synaptogenic agents. This guide covers the mechanism and research profile of every major nootropic peptide available for laboratory study.",
    content: `
...
*For laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "how-to-reconstitute-peptides-bacteriostatic-water-guide",
    title: "How to Reconstitute Research Peptides: Bacteriostatic Water, Storage, and Handling Protocol",
    date: "January 15, 2026",
    category: "Protocol Guide",
    readTime: "5 min read",
    excerpt: "Proper reconstitution technique is critical for maintaining peptide integrity in research settings. This protocol guide covers bacteriostatic water selection, reconstitution steps, storage conditions, and common handling errors.",
    content: `
...
*All Aeterion Labs peptides are supplied as lyophilized powder with ≥98-99% HPLC-verified purity. For laboratory research purposes only.*
  ...
  {
    slug: "oral-glp1-orforglipron-fda-review-2026",
    title: "Orforglipron: The First Oral GLP-1 Agonist Approaching FDA Approval in 2026",
    date: "January 8, 2026",
    category: "Clinical Research",
    readTime: "5 min read",
    excerpt: "Eli Lilly's orforglipron — a non-peptide oral GLP-1 receptor agonist — has completed Phase 3 trials and is under FDA review with an action date in May 2026. Here's what the research shows and why it matters.",
    content: `
...
*For laboratory research purposes only. Not for human consumption.*
  ...
  {
    slug: "peptide-purity-testing-hplc-coa-what-researchers-need-to-know",
    title: "Peptide Purity Testing: HPLC, Mass Spectrometry, and What a COA Actually Tells You",
    date: "December 28, 2025",
    category: "Quality & Standards",
    readTime: "6 min read",
    excerpt: "Not all peptide purity claims are equal. This guide explains what HPLC and mass spectrometry testing actually measure, how to read a Certificate of Analysis, and what to look for when evaluating a research peptide supplier.",
    content: `
    ...
    <>
      ...
      <div style={{ fontFamily: "'DM Sans', Arial, sans-serif", background: '#f8f9fb', minHeight: '100vh' }}>
        <header style={{ background: '#fff', borderBottom: '1px solid #e5e7eb', padding: '16px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <a href="/" style={{ background: '#1B3A6B', color: '#fff', padding: '10px 20px', borderRadius: 8, textDecoration: 'none', fontWeight: 600, fontSize: 14 }}>Shop Products</a>
        </header>

        <div style={{ background: 'linear-gradient(135deg, #1B3A6B 0%, #2B6CB0 100%)', color: '#fff', padding: '64px 24px', textAlign: 'center' }}>
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: 'rgba(255,255,255,0.6)', marginBottom: 12 }}>AETERION LABS</div>
          <h1 style={{ margin: '0 0 16px', fontSize: 40, fontWeight: 900, letterSpacing: -0.5 }}>Research & News</h1>
          <p style={{ margin: 0, fontSize: 18, color: 'rgba(255,255,255,0.75)', maxWidth: 540, marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.6 }}>
            Latest clinical trial results, FDA regulatory updates, and research guides.
          </p>
        </div>
            ...
            {posts.map(post => {
              ...
              return (
                <a key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none' }}>
                  <article style={{ background: '#fff', borderRadius: 16, border: '1px solid #e5e7eb', padding: '28px', height: '100%', display: 'flex', flexDirection: 'column', cursor: 'pointer' }}>
                    <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
                      <span style={{ background: cat.bg, color: cat.color, padding: '4px 10px', borderRadius: 20, fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 0.5 }}>{post.category}</span>
                      <span style={{ color: '#9CA3AF', fontSize: 12, display: 'flex', alignItems: 'center' }}>{post.readTime}</span>
                    </div>
                    <h2 style={{ margin: '0 0 12px', fontSize: 18, fontWeight: 800, color: '#1B3A6B', lineHeight: 1.35, flex: 1 }}>{post.title}</h2>
                    <p style={{ margin: '0 0 20px', fontSize: 14, color: '#6B7280', lineHeight: 1.7 }}>{post.excerpt}</p>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #F3F4F6', paddingTop: 16 }}>
                      ...
                      <span style={{ fontSize: 13, color: '#4A9FD4', fontWeight: 700 }}>Read more →</span>
                    </div>
                  </article>
                </a>
              )
...
export async function getStaticProps() {
  const posts = getAllPosts().map(({ slug, title, date, category, readTime, excerpt }) => ({
    slug, title, date, category, readTime, excerpt
  }))
  return { props: { posts } }
}
